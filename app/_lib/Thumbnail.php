...
class Thumbnail {
  ...
  public function __construct ($filepath = '', $class = '', $options = array ()) {
    Load::lib ('Thumbnail' . DIRECTORY_SEPARATOR . $class . EXT, '[Thumbnail] 載入物件失敗。');
  ...
  public static function createGdBlock9 ($files, $save) {
    Load::lib ('Thumbnail' . DIRECTORY_SEPARATOR . 'Gd' . EXT, '[Thumbnail] 載入物件失敗。');
  ...
  public static function createImagickBlock9 ($files, $save) {
    Load::lib ('Thumbnail' . DIRECTORY_SEPARATOR . 'Imagick' . EXT, '[Thumbnail] 載入物件失敗。');
