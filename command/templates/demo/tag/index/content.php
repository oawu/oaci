...
{<{<{ echo render_cell ('demo_cells', 'main_menu', array ()); ?>
  <a class='create' href='{<{<{ echo base_url (array ('tags', 'add'));?>'>新增</a>
  {<{<{
...
{<{<{ if ($tags) {
        foreach ($tags as $tag) { ?>
          <tr>
            ...
            <td>{<{<{ echo $tag->name;?></td>
            <td>
              <a href='{<{<{ echo base_url (array ('tags', 'edit', $tag->id));?>'>
            ...
            <td>
              <a href='{<{<{ echo base_url (array ('tags', 'destroy', $tag->id));?>'>
                &#10006;
              </a>
            </td>
          </tr>
