...
<div class='panel'>
  <form class='form-type1 loading' action='<?php echo base_url ($uri_1);?>' method='post' enctype='multipart/form-data'>
    ...
    <div class='row'>
      ...
      <input type='text' name='href' value='<?php echo isset ($posts['href']) ? $posts['href'] : '';?>' placeholder='請輸入<?php echo $title;?>鏈結..' maxlength='200' pattern='.{1,200}' required title='輸入<?php echo $title;?>鏈結!' />
    </div>
