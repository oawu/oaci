...
<div class='panel'>
  <form class='form-type1' action='<?php echo base_url ($uri_1);?>' method='post' enctype='multipart/form-data'>
...
<?php }?>
    ...
    <div class='row'>
      ...
      <textarea name='content' class='cke' placeholder='請輸入文章內容..'><?php echo isset ($posts['content']) ? $posts['content'] : '';?></textarea>
    </div>

    <div class='row'>
      <b>文章備註</b>
      <textarea name='memo' placeholder='請輸入文章備註..'><?php echo isset ($posts['memo']) ? $posts['memo'] : '';?></textarea>
    </div> 
