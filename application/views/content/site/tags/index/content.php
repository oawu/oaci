...
<?php echo render_cell ('demo_cell', 'main_menu', array ()); ?>
  <a class='create' href='<?php echo base_url (array ('tags', 'add'));?>'>新增</a>
  <?php
...
<?php if ($tags) {
        foreach ($tags as $tag) { ?>
          <tr>
            ...
            <td>
              <a href='<?php echo base_url (array ('tags', 'show', $tag->id));?>'>
            ...
            <td>
              <a href='<?php echo base_url (array ('tags', 'edit', $tag->id));?>'>
            ...
            <td>
              <a href='<?php echo base_url (array ('tags', 'destroy', $tag->id));?>'>
                &#10006;
              </a>
            </td>
          </tr>
