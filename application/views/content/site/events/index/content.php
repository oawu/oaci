...
<?php echo render_cell ('demo_cell', 'main_menu', array ()); ?>
  <a class='create' href='<?php echo base_url (array ('events', 'add'));?>'>新增</a>
  <?php
...
<?php if ($events) {
        foreach ($events as $event) { ?>
          <tr>
            ...
            <td><?php echo img ($event->cover->url ('100w'));?></td>
            <td><?php echo count ($event->attendees);?></td>
            <td>
              <a href='<?php echo base_url (array ('events', 'show', $event->id));?>'>
            ...
            <td>
              <a href='<?php echo base_url (array ('events', 'edit', $event->id));?>'>
            ...
            <td>
              <a href='<?php echo base_url (array ('events', 'destroy', $event->id));?>'>
                &#10006;
              </a>
            </td>
          </tr>
