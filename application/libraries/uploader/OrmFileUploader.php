...
class OrmFileUploader extends OrmUploader {
  ...
  //   $this->configs = Cfg::system ('orm_uploader');
  //   $this->error = null;
  ...
  //   if (is_readable ($path = FCPATH . implode (DIRECTORY_SEPARATOR, array_merge (Cfg::system ('orm_uploader', 'instance', 'directory'), array ($class_name . EXT)))))
  //     require_once $path;
  //   else
